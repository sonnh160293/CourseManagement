...
namespace Student_Management_Client.Pages.Admin.Students
{
    public class IndexModel : PageModel
    {
        ...
        {
            HttpRequestMessage requestSubject = new HttpRequestMessage(HttpMethod.Get, $"http://localhost:5172/api/Student?majorId={SelectedMajorId}&studentCode={SelectedCode}&currentTerm={SelectedTerm}");
            ...
            if (responseSubject.IsSuccessStatusCode)
            {
                ...
                Students = JsonSerializer.Deserialize<List<StudentGetDTO>>(dataSubject, option);
            }
